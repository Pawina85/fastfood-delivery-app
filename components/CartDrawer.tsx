...
export default function CartDrawer() {
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div className="fixed right-0 top-0 h-full w-full sm:w-96 bg-white shadow-2xl z-[70] flex flex-col transform transition-transform duration-300">
        {/* Header */}
        ...
        {/* Footer */}
        {items.length > 0 && (
          <div className="border-t p-4 pb-24 md:pb-4 space-y-3">
